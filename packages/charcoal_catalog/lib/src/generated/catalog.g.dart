...
const String generatedCatalogJson = r'''{
  ...
  "coverage": {
    "publicComponents": 35,
    "curatedComponents": 35,
    "componentsWithExamples": 35,
    "curatedPatterns": 6,
    "publicTokens": 502,
    "semanticTokens": 226
  },
  ...
  "components": [
    ...
    {
      "name": "CharcoalScaffold",
      "category": "Layout",
      "summary": "Coordinates page navigation, full-bleed backgrounds, safe areas, and keyboard avoidance.",
      "import": "package:charcoal_ui/charcoal_ui.dart",
      "sourcePath": "packages/charcoal_ui/lib/src/app/charcoal_scaffold.dart",
      "documentationLevel": "curated",
      "keywords": [
        "scaffold",
        "page",
      ...
      "avoidWhen": [
        "A small component only needs local layout constraints."
      ],
      "accessibility": [
      ...
      "apis": [
        {
          "name": "CharcoalScaffold",
          "kind": "constructor",
          "signature": "CharcoalScaffold({required this.body, this.navigationBar, this.bottomBar, this.backgroundColor, this.systemOverlayStyle, this.bodySafeArea = true, this.extendBodyBehindNavigationBar = false, this.resizeToAvoidBottomInset = true, super.key})",
          "parameters": [
            {
              "name": "body",
              "type": "Widget",
            ...
            {
              "name": "extendBodyBehindNavigationBar",
              "type": "bool",
              "required": false,
              "named": true,
              "defaultValue": "false"
        ...
        {
          "name": "configureCharcoalSystemUi",
          "kind": "function",
          "signature": "Future<void> configureCharcoalSystemUi({SystemUiMode mode = SystemUiMode.edgeToEdge})",
          "parameters": [
            {
              "name": "mode",
              "type": "SystemUiMode",
              "required": false,
              "named": true,
              "defaultValue": "SystemUiMode.edgeToEdge"
            }
          ],
          "enumValues": []
        }
      ...
      "apis": [
        {
          ...
          "parameters": [
            ...
            },
            {
              ...
              "required": false,
              "named": true,
              "defaultValue": "buildCharcoalTextContextMenu"
            },
            {
